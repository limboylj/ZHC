	...
	public function main()
	{
		...
		if (!$share_goods) {
			if (empty($set['closemyshop'])) {
				$_W['shopshare'] = array('imgUrl' => $myshop['logo'], 'title' => '分享二维码', 'desc' => '扫描'.$member['nickname'].'的二维码,一起加入“Dian商+区块链”商圈吧！', 'link' => mobileUrl('commission/share', array('mid' => $member['id']), true));
