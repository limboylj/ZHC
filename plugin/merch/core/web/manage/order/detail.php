...
class Detail_EweiShopV2Page extends MerchWebPage
{
	public function main()
	{
		...
		$p = p('commission');
		$item = pdo_fetch('SELECT * FROM ' . tablename('ewei_shop_order') . ' WHERE id = :id and uniacid=:uniacid and (merchid = :merchid or omerchid = :merchid) Limit 1', array(':id' => $id, ':uniacid' => $_W['uniacid'], ':merchid' => $_W['merchid']));
