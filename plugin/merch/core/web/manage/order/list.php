...
{
	protected function orderData($status, $st, $main_platform=false) 
	{
		global $_W;
		global $_GPC;
		...
		if($main_platform){
			$merchid_str = 'o.omerchid';
		} else {
			$merchid_str = 'o.merchid';
		}
		$condition = ' o.uniacid = :uniacid and '.$merchid_str.'=:merchid and o.deleted=0 and o.isparent=0';
		$uniacid = $_W['uniacid'];
		$merchid = $_W['merchid'];
