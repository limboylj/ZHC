...
if ($_W['ispost']) 
{
	...
	$data['omerchid'] = intval($_GPC['omerchid']);
...
if(!empty($item['omerchid'])){
	$merch = pdo_fetch('SELECT id,merchname FROM ' . tablename('ewei_shop_merch_user') . ' WHERE uniacid='. $_W['uniacid'] .' and id='.$item['omerchid']);	
}
