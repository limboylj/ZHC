...
class Verifygoods_EweiShopV2Page extends MobilePage 
{
	...
	public function finishorder($id) 
	{
		...
		/*$goods = pdo_fetch('select id,goodsid,total,realprice from ' . tablename('ewei_shop_order_goods') . ' where  orderid=:orderid and uniacid=:uniacid limit 1', array(':uniacid' => $_W['uniacid'], ':orderid' => $id));
